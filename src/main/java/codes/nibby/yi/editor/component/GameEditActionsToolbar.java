 ...
 */
public class GameEditActionsToolbar extends ToolBar {
    ...
    public GameEditActionsToolbar(GameEditorWindow editor) {
        this.editor = editor;
...
//            editor.getGobanEditor().setDrawLabels(buttonShowLabel.isSelected());
        ...
        ImageView buttonShowTrayIcon = new ImageView(new Image(GameEditActionsToolbar.class.getResourceAsStream("/icons/arrow_right_invert.png")));
        ...
        buttonShowTray.setOnAction(evt -> {
            ...
            ImageView icon = new ImageView(new Image(GameEditActionsToolbar.class.getResourceAsStream(iconPath)));
    ...
    private void addToolButton(ToggleButton b, String icon, String tooltip, boolean group) {
        ...
        if (!icon.isEmpty()) {
            InputStream inputStream = GameEditActionsToolbar.class.getResourceAsStream("/icons/" + icon + "_invert.png");
        ...
        b.selectedProperty().addListener(e -> {
            boolean selected = b.isSelected();
            if (!icon.isEmpty()) {
                InputStream inputStream = GameEditActionsToolbar.class
