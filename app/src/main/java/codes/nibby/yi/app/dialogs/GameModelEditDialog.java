...
public final class GameModelEditDialog extends YiAbstractModalPane {
    ...
    public final ModalActionButton actionButton = new ModalActionButton(ActionType.PRIMARY, AppText.EMPTY);
    public final ModalActionButton cancelButton = new ModalActionButton(ActionType.SECONDARY, AppText.CANCEL);
    ...
    static {
        RULESET_TRANSLATIONS.put(StandardGameRules.CHINESE.getRulesHandler(),
                new GameRulesValue(StandardGameRules.CHINESE, AppText.CHINESE_RULESET));
    }
    ...
    public GameModelEditDialog() {
        this.isNewModel = true;
        this.gameModel = null;
        setupActionButtons();
    }

    public GameModelEditDialog(@Nullable GameModel gameModel) {
    ...
    private void setupActionButtons() {
        actionButton.setText(isNewModel ? AppText.CREATE : AppText.SAVE);
    ...
    public void applyChangesToGameModel() {
        if (gameModel == null) {
            throw new IllegalStateException(
                "Attempting to apply edits to existing game model but it is null"
            );
        }
    ...
    private String getPlayerWhiteName() {
        return getNameOrDefault(playerWhiteName, AppText.DEFAULT_WHITE_NAME.getLocalisedText());
    }

    private String getPlayerBlackName() {
        return getNameOrDefault(playerBlackName, AppText.DEFAULT_BLACK_NAME.getLocalisedText());
    }
