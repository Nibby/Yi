...
import codes.nibby.yi.app.framework.modal.YiModalContent;
...
public final class YiScene {
    ...
    public YiScene() {
        ...
        YiSkinManager.getUsedSkin().ifPresent(skin -> skin.apply(scene));
    ...
    // TODO: Not intended to be public
    public GlassPane _getGlassPane() {
        return glassPane;
    }

    // TODO: Not intended to be public
    public Stack<YiModalContent> _getModalStack() {
     ...
     */
    // TODO: Not intended to be public
    public static final class GlassPane extends BorderPane {
