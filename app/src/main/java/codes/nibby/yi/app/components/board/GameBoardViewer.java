...
import codes.nibby.yi.app.framework.property.BooleanPropertyListener;
import codes.nibby.yi.app.framework.property.NullablePropertyListener;
import codes.nibby.yi.app.audio.StoneAudioSet;
import codes.nibby.yi.app.framework.YiCanvasContainer;
...
public final class GameBoardViewer implements YiComponent {
    ...
    private final YiCanvasContainer container;
    ...
    public GameBoardViewer() {
        ...
        container = new YiCanvasContainer(content);
