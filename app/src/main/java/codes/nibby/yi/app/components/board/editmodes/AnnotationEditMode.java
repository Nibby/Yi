...
import codes.nibby.yi.app.components.board.AnnotationRenderer;
import codes.nibby.yi.app.components.board.GameBoardManager;
import codes.nibby.yi.app.components.board.GameBoardSize;
import codes.nibby.yi.models.Annotation;
import codes.nibby.yi.models.AnnotationType;
import codes.nibby.yi.models.editor.edit.AnnotationEdit;
...
/**
 * Edit mode that manipulates annotation data on a {@link GameNode}.
 */
