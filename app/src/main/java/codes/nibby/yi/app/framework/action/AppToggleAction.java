...
import codes.nibby.yi.app.framework.YiCheckMenuItem;
...
public class AppToggleAction extends AppAbstractAction<YiCheckMenuItem, YiToggleButton> {
    ...
    public AppToggleAction(@NotNull TextResource name,
    ...
    @Override
    public AppToggleAction setAccelerator(AppAccelerator acceleratorId) {
        super.setAccelerator(acceleratorId);
        return this;
    }

    @Override
    public AppToggleAction setInMenuBar(@NotNull AppMainMenuType menu, double position) {
        super.setInMenuBar(menu, position);
        return this;
    }

    @Override
    public AppToggleAction setText(@NotNull TextResource i18nKey) {
        super.setText(i18nKey);
        return this;
    }

    @Override
    public AppToggleAction setIcon(@Nullable ImageView icon) {
        super.setIcon(icon);
        return this;
    }

    @Override
    public AppToggleAction setEnabled(boolean enabled) {
        super.setEnabled(enabled);
        return this;
    }

    @Override
    public AppToggleAction setVisible(boolean visible) {
