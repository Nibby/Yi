...
class GameModelInfo {
    ...
    private fun get(key: String): Optional<Any> {
    ...
    fun getHandicapCount(): Int {
        return get(KEY_HANDICAP_COUNT).orElse(0) as Int
    }
    ...
    fun getApplicationName(): String {
        return get(KEY_APPLICATION_NAME).orElse("") as String
    }
     ...
     */
    fun getKomi(): Float {
        return get(KEY_KOMI).orElse(0f) as Float
    }
    ...
    fun getPlayerBlackName(): String {
        return get(KEY_PLAYER_BLACK_NAME).orElse("") as String
    }
    ...
    fun getPlayerBlackRank(): String {
        return get(KEY_PLAYER_BLACK_RANK).orElse("") as String
    }
    ...
    fun getPlayerWhiteName(): String {
        return get(KEY_PLAYER_WHITE_NAME).orElse("") as String
    }
    ...
    fun getPlayerWhiteRank(): String {
        return get(KEY_PLAYER_WHITE_RANK).orElse("") as String
    }
