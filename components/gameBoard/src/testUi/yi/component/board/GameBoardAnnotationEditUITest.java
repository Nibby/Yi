...
public final class GameBoardAnnotationEditUITest extends GameBoardUITestBase {
    ...
    public void testAddOne_PointAnnotation(FxRobot robot) {
        ...
        assertTrue(getGameModel().getCurrentMoveStateDelta().getAnnotationsOnThisNode().contains(new Annotation.Square(0, 0)),
    ...
    public void testAddMultiple_PointAnnotation(FxRobot robot) {
        ...
        for (int i = 0; i < getBoardWidth(); ++i) {
            assertTrue(getGameModel().getCurrentMoveStateDelta().getAnnotationsOnThisNode().contains(new Annotation.Square(i, 0)),
    ...
    public void testEraseMultiple_PointAnnotation(FxRobot robot) {
        ...
        assertEquals(0, getGameModel().getCurrentMoveStateDelta().getAnnotationsOnThisNode().size(),
    ...
    public void testAddMultiple_PointAnnotation_ReplaceExistingAnnotations(FxRobot robot) {
        ...
        for (int i = 0; i < getBoardWidth(); ++i) {
            assertTrue(getGameModel().getCurrentMoveStateDelta().getAnnotationsOnThisNode().contains(new Annotation.Cross(i, 0)),
    ...
    private void testAddLabel_OneAtATime_TextIsDifferent(FxRobot robot, AnnotationEditMode.LabelType labelType) {
        ...
        var annotations = getGameModel().getCurrentMoveStateDelta().getAnnotationsOnThisNode();
